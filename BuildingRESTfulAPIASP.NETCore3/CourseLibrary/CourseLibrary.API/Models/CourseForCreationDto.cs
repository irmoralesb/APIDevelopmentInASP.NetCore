...
{   //these validations returns  400 error code instead of 422 , so a custom code was added to Startup.cs file
    ...
    public class CourseForCreationDto : IValidatableObject //The validation implemented by this interface ONLY is executed when the property validations are executed and passed
    {
